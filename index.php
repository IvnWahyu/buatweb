      ...
      <div class="seq-preloader">
        ...
        <nav>
          ...
          <ul>
            ...
            <li><a href="#4"><i class="fa fa-image"></i> <em>Certificate</em></a></li>
...
?>
                                        <div class="col-md-6">
                                            <div class="left-content">
                                                ...
                                                <div class="fb-btn"><a rel="nofollow" href="https://github.com/IvnWahyu/PBO" target="_blank">GitHub</a></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="right-image">
...
?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="right-content">
                                                <h2><?= $row["judul"]; ?></h2>
                                                <p><?= $row["deskripsiPendek"]; ?></p>
                                                <div class="fb-btn"><a rel="nofollow" href="https://github.com/IvnWahyu/DAA" target="_blank">GitHub</a></div>
                                            </div>
                                        </div>
...
?>
                            <div class="item">
                                <div class="thumb">
                                    <a href="img/first_big_item1.jpg" data-lightbox="image-1"><div class="hover-effect">
...
?>
                            <div class="item">
                                <div class="thumb">
                                    <a href="img/second_big_item1.jpg" data-lightbox="image-1"><div class="hover-effect">
                                        <div class="hover-content">
                                            <h2><?= $row["judul"]; ?></h2>
                                            <p><?= $row["subjudul"]; ?></p>
                                        </div>
...
?>
                            <div class="item">
                                <div class="thumb">
                                    <a href="img/fourth_big_item1.jpg" data-lightbox="image-1"><div class="hover-effect">
                                        <div class="hover-content">
                                            <h2><?= $row["judul"]; ?></h2>
                                            <p><?= $row["subjudul"]; ?></p>
                                        </div>
